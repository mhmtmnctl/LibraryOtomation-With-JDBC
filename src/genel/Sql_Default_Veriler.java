...
public class Sql_Default_Veriler {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String sql1 = "CREATE TABLE books(kitapId SERIAL PRIMARY KEY,kitapAdi VARCHAR(50), kitapYazari VARCHAR(50),kitapTuru VARCHAR(20),alinaBilirMi boolean,alinmaTarihi VARCHAR(12),alanKisi VARCHAR(60))";
        st.execute(sql1);
        ...
        st.execute("INSERT INTO kullanicilar(kullaniciId,kullaniciAdi,kullaniciSoyadi,kullaniciMail,kullaniciSifre,kullaniciTelNo,kullaniciPuan) VALUES (DEFAULT,'Ersin','AKUN','ersinakun34@gmail.com','1234','2126140853',10)");
        st.execute("INSERT INTO kullanicilar(kullaniciId,kullaniciAdi,kullaniciSoyadi,kullaniciMail,kullaniciSifre,kullaniciTelNo,kullaniciPuan) VALUES (DEFAULT,'Sezer','ERCAN','sercan@gmail.com','4321','2121231212',10)");
